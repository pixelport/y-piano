...
export class OctaveSelector extends React.Component{
  ...
  render(){
    ...
    return (<div className="octave-selector">
        ...
        <a className={"uk-button uk-button-primary small-arrow-btn " + (octaveOffset >= 5 ? "uk-disabled" : "")} onClick={() => setOctaveOffset(octaveOffset + 1)}><i className="fas fa-arrow-right"></i></a>
    </div>)
  }
}